...
namespace Sales.API.Migrations
{
    ...
    [Migration("20231010095010_Users")]
    partial class Users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sales.Share.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Sales.Share.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sales.Share.Entities.User", b =>
                {
                    b.HasOne("Sales.Share.Entities.City", "City")
                        .WithMany("Users")
